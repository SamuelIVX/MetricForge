...
/**
 * Demo linear line chart for the history insights strip (Recharts + shadcn Chart).
...
/**
 * Renders the history-page linear line chart demo.
    ...
    return (
        <Card className="p-3 bg-[#0b0b0d]">
            <CardHeader className="p-0 ">
                <CardTitle className="text-sm text-white">Total Tasks Completed Per Week</CardTitle>
